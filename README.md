...
Nothing in that header or block mentions miners, mining, QRL, or wallets; it’s pure app/assistant‑ui branding per the assistant‑ui project style.

need back in full all features as last nothing about a miner at all{/* Onyx logo – put your file in /public/onyx-logo.svg */} ONYX.AI APP Created by Zeus · Creator: Mark
<div className="flex items-center gap-2 text-xs text-neutral-400">
<span className="px-2 py-0.5 rounded-full border border-purple-500/60 bg-purple-700/30 text-purple-100">
Powered by assistant‑ui
</span>
...
AI Assistant Ownership
[](https://github.com/MrGoodKitten/onyx-ai-app/edit/main/README.md#ai-assistant-ownership)
This project implements the ONYX.AI 4 assistant experience using the open source assistant-ui React library under the MIT license.
All ONYX.AI 4 rules, system prompts, agent logic, and configurations are original creations of ZEUS and remain proprietary to ZEUS, even when rendered through third-party UI components like @assistant-ui/react.
Unauthorized copying, redistribution, or reuse of ONYX.AI 4 rules, prompts, or system logic is strictly prohibited, regardless of the frontend UI framework used.
The UX of ChatGPT in your React app 💬🚀
[](https://github.com/MrGoodKitten/onyx-ai-app/edit/main/README.md#the-ux-of-chatgpt-in-your-react-app-)
...
Why assistant-ui
[](https://github.com/MrGoodKitten/onyx-ai-app/edit/main/README.md#why-assistant-ui)
...
Getting Started
[](https://github.com/MrGoodKitten/onyx-ai-app/edit/main/README.md#getting-started)
...
![npm version](https://www.npmjs.com/package/@assistant-ui/react)
![npm downloads](https://www.npmjs.com/package/@assistant-ui/react)
![Ask DeepWiki](https://deepwiki.com/assistant-ui/assistant-ui)
![Weave Badge](https://app.workweave.ai/reports/repository/org_GhSIrtWo37b5B3Mv0At3wQ1Q/722184017)
!GitHub License
...
!GitHub License
!Backed by Y Combinator
<!-- ![Manta Graph badge](https://getmanta.ai/assistant-ui) -->
...
This project implements the ONYX.AI 4 assistant experience using the open source
assistant-ui React library under the MIT license.

All ONYX.AI 4 rules, system prompts, agent logic, and configurations are
original creations of ZEUS and remain proprietary to ZEUS, even when rendered
through third-party UI components like `@assistant-ui/react`.

> Unauthorized copying, redistribution, or reuse of ONYX.AI 4 rules, prompts,
> or system logic is strictly prohibited, regardless of the frontend UI
> framework used.
...
Book a sales call
Here’s the same content, fully restored with all features and no miner/QRL language anywhere. I’ve only renamed the header label to remove “MINERS” and kept everything else intact.
